 ...
 *    
 */
package org.geosde.compute.process.geometry;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

import org.geosde.compute.process.ProcessException;
...
/**
 * A set of static functions providing the implementation of processes exposed
 * by the {@link GeometryProcessFactory}.
 * 
 * @author Andrea Aime
 *
 * @source $URL$
...
public class GeometryFunctions {
	...
	/**
	 * Maps the enumeration into the set of values used by the JTS
	 * {@link BufferParameters} class.
	 * 
	...
	static public Geometry buffer(@DescribeParameter(name = "geom", description = "Input geometry") Geometry geom,
	...
	static public boolean equalsExactTolerance(
			@DescribeParameter(name = "a", description = "First input geometry") Geometry a,
			@DescribeParameter(name = "b", description = "Second input geometry") Geometry b,
			@DescribeParameter(name = "tolerance", description = "Tolerance distance for vertex equality test") double tolerance) {
	...
	static public int numGeometries(
	...
	static public Geometry getGeometryN(
	...
	static public Point pointN(@DescribeParameter(name = "geom", description = "Input geometry") LineString line,
	...
	static public Geometry exteriorRing(
	...
	static public int numInteriorRing(
			@DescribeParameter(name = "geom", description = "Input geometry") Polygon polygon) {
	...
	static public Geometry interiorRingN(
